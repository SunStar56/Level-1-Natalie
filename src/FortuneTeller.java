...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	FortuneTeller() throws Exception {
		...
		// package
		fortuneTellerImage = ImageIO.read(getClass().getResource("BurritoCat.jpeg"));
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "hAi i'M bURRiTo KaT!  KliK mEH nAUs tO STaRT!");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			JOptionPane.showInputDialog("ASk MeH a QUEsTioN!");
