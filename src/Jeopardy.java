...
public class Jeopardy implements ActionListener {
	...
	// * 13. Use the method provided to play the Jeo//

	// * 14. Add buttons so that you have $200, $400, $600, $800 and $1000
	// * questions
	// *
	// * [optional] Use the showImage or playSound methods when the user answers
	// a
	// * question
	// *
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("This animal is able to change colors to match its environment.", "Chameleon", 200);
			firstButton.setText("");
